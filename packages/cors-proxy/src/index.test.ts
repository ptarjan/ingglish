...
describe('cors-proxy', () => {
  ...
  describe('isPrivateHost', () => {
    it.each([
      ...
      ['100.64.0.1', true, 'CGNAT start (100.64.0.0/10)'],
      ['100.100.100.100', true, 'CGNAT mid (cloud metadata alt)'],
      ['100.127.255.255', true, 'CGNAT end'],
      ['100.63.0.1', false, 'below CGNAT range'],
      ...
      ['198.18.0.1', true, 'benchmarking start (198.18.0.0/15)'],
      ['198.19.255.255', true, 'benchmarking end'],
      ['198.20.0.1', false, 'above benchmarking range'],
      ['224.0.0.1', true, 'multicast'],
      ['255.255.255.255', true, 'broadcast'],
      ['223.255.255.255', false, 'top of unicast space'],
