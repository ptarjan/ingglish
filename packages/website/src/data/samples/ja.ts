...
export const ja: ForeignSample[] = [
  ...
  {
    // https://www.aozora.gr.jp/cards/000879/files/33_15286.html
    label: '芥川龍之介 — 蜘蛛の糸',
  ...
  {
    // https://www.aozora.gr.jp/cards/000042/files/818_15954.html
    label: '森鷗外 — 舞姫',
  ...
  {
    // https://www.sainet.or.jp/~eshibuya/
    label: '紫式部 — 源氏物語',
