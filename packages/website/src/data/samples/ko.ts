...
export const ko: Sample[] = [
  {
    label: '윤동주 — 서시',
    source: 'https://ko.wikisource.org/wiki/하늘과_바람과_별과_시_(1948년)/서시',
    text: '죽다 날 까지 하늘 을 우러르다 한 점 부끄럼 이 없다 기 를 잎새 에 이다 바람 에 도 나 는 괴롭다 별 을 노래 하다 마음 으로 모든 죽다 가다 것 을 사랑 하다 그리고 나 한테 주다 길 을 걷다',
  },
  {
    label: '윤동주 — 별 헤는 밤',
    source: 'https://ko.wikisource.org/wiki/하늘과_바람과_별과_시_(1948년)/별_헤는_밤',
  ...
  {
    label: '현진건 — 운수 좋은 날',
    source: 'https://ko.wikisource.org/wiki/운수_좋은_날',
    text: '그 는 인력거 꾼 이다 그 날 은 손님 이 많다 아침 부터 운수 가 좋다 돈 을 많다 벌다 그러나 아내 는 병 이 들다 있다 그 는 집 으로 돌아가다 것 을 두렵다 하다',
  },
  {
    label: '기미독립선언서 — 1919년',
  ...
  {
    label: '이상화 — 빼앗긴 들에도 봄은 오는가',
    source: 'https://ko.wikisource.org/wiki/빼앗긴_들에도_봄은_오는가',
    text: '지금 은 남 의 땅 이다 빼앗기다 들 에 도 봄 은 오다 나 는 온몸 에 햇살 을 받다 푸르다 하늘 푸르다 들 을 지나다 논길 을 따르다 꿈속 을 가다 듯 걷다 만 가다',
  },
  {
    label: '이상 — 날개',
    source: 'https://ko.wikisource.org/wiki/날개',
    text: '박제 가 되다 천재 를 아시다 나 는 유쾌하다 도 하다 이런 때 에 연구 가 좋다 않다 아내 가 있다 때 아내 가 없다 때 그것 은 비슷하다',
  },
  {
    label: '이효석 — 메밀꽃 필 무렵',
    source: 'https://ko.wikisource.org/wiki/메밀꽃_필_무렵',
    text: '여름 장 은 이미 끝나다 있다 해 는 아직 중천 에 있다 장터 는 쓸쓸하다 사람 들 은 거의 돌아가다 있다 상인 은 친구 에게 말하다 오늘 밤 은 달 이 밝다 걸다 가다 좋다 이다',
  },
  {
    label: '윤동주 — 자화상',
    source: 'https://ko.wikisource.org/wiki/하늘과_바람과_별과_시_(1948년)/자화상',
    text: '산모퉁이 를 돌다 가다 논가 외딴 우물 을 홀로 찾다 가다 가만히 들여다보다 우물 속 에 는 달 이 밝다 구름 이 흐르다 하늘 이 펼치다 파랗다 바람 이 있다 가을 이 있다',
  },
  {
    label: '이광수 — 무정',
    source: 'https://ko.wikisource.org/wiki/무정/1장~20장',
    text: '경성 학교 영어 교사 이 형식 은 나이 스물 여섯 에 키 가 오 척 여섯 치 가 넘다 시원하다 이마 에 빛나다 눈 을 가지다 쾌활하다 청년 이다 사범 학교 를 나오다 뒤 에 미국 에 유학 하다',
  },
  {
    label: '김유정 — 동백꽃',
    source: 'https://ko.wikisource.org/wiki/동백꽃',
    text: '나 는 점순이 가 좋다 해 뜨다 잠자코 나 의 일 을 도우다 주다 점순이 가 이쁘다 나 는 저 아이 가 좋다 간 까지 빼다 먹다 싶다 하다',
  },
  {
    label: '김영랑 — 모란이 피기까지는',
    source: 'https://ko.wikisource.org/wiki/영랑시집/모란이_피기까지는',
    text: '모란 이 피다 까지 는 나 는 아직 나 의 봄 을 기다리다 있다 모란 이 뚝뚝 떨어지다 버리다 날 나 는 비로소 봄 을 여의다 서러움 에 잠기다',
  },
  {
    label: '한용운 — 알 수 없어요',
    source: 'https://ko.wikisource.org/wiki/님의_침묵/알_수_없어요',
