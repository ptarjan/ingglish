...
export const ko: ForeignSample[] = [
  ...
  {
    // Korean proverb sentences
    label: '한국 속담 — 지혜의 말씀',
    text: '가는 말 이 곱다 야 오다 말 이 곱다 낮 말 은 새 가 듣다 밤 말 은 쥐 가 듣다 천 리 길 도 한 걸음 부터 콩 심다 데 콩 나다 팥 심다 데 팥 나다 세월 은 사람 을 기다리다 않다',
  },
  {
  ...
  {
    // https://ko.wikipedia.org/wiki/홍길동전
    label: '허균 — 홍길동전',
    text: '홍 판서 의 집 에 서자 하나 태어나다 이름 은 길동 이다 길동 은 어리다 때 부터 총명하다 기운 이 남다르다 그러나 서자 이다 고로 아버지 를 아버지 라 부르다 못하다 형 을 형 이라 부르다 못하다',
  },
  {
    // Shin Kyungrim
    label: '신경림 — 농무',
