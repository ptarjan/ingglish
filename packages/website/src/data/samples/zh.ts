...
export const zh: ForeignSample[] = [
  ...
  {
    // https://baike.baidu.com/item/分久必合，合久必分
    label: '罗贯中 — 三国演义',
    text: '话 说 天 下 大 势 分 久 必 合 合 久 必 分 周 末 七 国 分 争 并 入 于 秦 及 秦 灭 之 后 楚 汉 分 争 又 并 入 于 汉',
  },
  {
    // https://www.marxists.org/reference/archive/mao/selected-works/poems/poems18.htm
    label: '毛泽东 — 沁园春·雪',
  ...
  {
    // https://blog.sina.com.cn/s/blog_6416a6200102wi01.html
    label: '沈从文 — 边城',
