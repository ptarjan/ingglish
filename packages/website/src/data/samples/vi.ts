...
export const vi: Sample[] = [
  ...
  {
    // https://www.thivien.net/Hồ-Chí-Minh/Vọng-nguyệt/poem-5rhhpzHYKx4bI46F3xhIQA
  ...
  {
    // https://www.thivien.net/Nguyễn-Trãi/Bình-Ngô-đại-cáo/poem-mLEGY5d9nFI0RH280X-vIQ
  ...
  {
    // https://www.thivien.net/Xuân-Diệu/Vội-vàng/poem-IyS6PGZk72z5lfRoUlCUtg
  ...
  {
    // https://vi.wikisource.org/wiki/Chí_Phèo
  ...
  {
    // https://en.wikipedia.org/wiki/Tiến_quân_ca
  ...
  {
    // https://www.daovien.net/t5-topic
  ...
  {
    // https://www.thivien.net/Nguyễn-Khuyến/Thu-điếu/poem-lb0C1LYxo0fcanV11dmAog
  ...
  {
    // https://www.thivien.net/Tố-Hữu/Việt-Bắc/poem-v9h1P_8l-sRaiDRUqg2JRQ
  ...
  {
    // https://www.thivien.net/Nguyễn-Bỉnh-Khiêm/author-Rv6locqJPIunovJpeqDNxA
  ...
  {
    // https://www.thivien.net/Thế-Lữ/Nhớ-rừng/poem-_ykWImldKwdEntynhnNLUA
  ...
  {
    // https://www.thivien.net/Hàn-Mặc-Tử/Đây-thôn-Vĩ-Dạ/poem-mYEcs2AZA6uARv-MA69oaA
  ...
  {
    // https://www.thivien.net/Huy-Cận/Tràng-giang/poem-tzEin01iG68zsm2nWGm0IQ
  ...
  {
    // https://www.thivien.net/Lưu-Trọng-Lư/Tiếng-thu/poem-jvbfrjspi2Y6S8b3jeqzpA
