...
export const vi: Sample[] = [
  {
    ...
    source: 'https://vietnamesetypography.com/samples/truyen-kieu/',
  ...
  },
  {
    ...
    source: 'https://www.thivien.net/Hồ-Xuân-Hương/Thơ-tự-tình/poem-ZG1snfgbwBOBCSAnwp2z4w',
  ...
  {
    label: 'Hồ Chí Minh — Tuyên ngôn Độc lập',
    source: 'https://vietnamnet.vn/toan-van-ban-tuyen-ngon-doc-lap-771240.html',
  ...
  {
    label: 'Hồ Chí Minh — Ngắm trăng',
    source: 'https://www.thivien.net/Hồ-Chí-Minh/Vọng-nguyệt/poem-5rhhpzHYKx4bI46F3xhIQA',
    text: 'Trong tù không rượu cũng không hoa, cảnh đẹp đêm nay, khó hững hờ. Người ngắm trăng soi ngoài cửa sổ, trăng nhòm khe cửa ngắm nhà thơ.',
  },
  {
  ...
  },
  {
    ...
    source: 'https://www.thivien.net/Xuân-Diệu/Vội-vàng/poem-IyS6PGZk72z5lfRoUlCUtg',
  ...
  },
  {
    ...
    source: 'https://vi.wikisource.org/wiki/Chí_Phèo',
    text: 'Hắn vừa đi vừa chửi. Bao giờ cũng thế, cứ rượu xong là hắn chửi. Bắt đầu hắn chửi trời. Có hề gì? Trời có của riêng nhà nào? Rồi hắn chửi đời. Thế cũng chẳng sao: đời là tất cả nhưng chẳng là ai.',
  },
  {
    label: 'Văn Cao — Tiến Quân Ca',
    source: 'https://en.wikipedia.org/wiki/Tiến_quân_ca',
    text: 'Đoàn quân Việt Nam đi, chung lòng cứu quốc, bước chân dồn vang trên đường gập ghềnh xa. Cờ in máu chiến thắng mang hồn nước, súng ngoài xa chen khúc quân hành ca.',
  },
  {
    label: 'Đặng Trần Côn — Chinh Phụ Ngâm',
    source: 'https://www.daovien.net/t5-topic',
    text: 'Thuở trời đất nổi cơn gió bụi, khách má hồng nhiều nỗi truân chuyên. Xanh kia thăm thẳm tầng trên, vì ai gây dựng cho nên nỗi này.',
  },
  {
    label: 'Nguyễn Khuyến — Thu điếu',
    source: 'https://www.thivien.net/Nguyễn-Khuyến/Thu-điếu/poem-lb0C1LYxo0fcanV11dmAog',
  ...
  },
  {
    ...
    source: 'https://www.thivien.net/Tố-Hữu/Việt-Bắc/poem-v9h1P_8l-sRaiDRUqg2JRQ',
  ...
  },
  {
    ...
    source: 'https://www.thivien.net/Nguyễn-Bỉnh-Khiêm/author-Rv6locqJPIunovJpeqDNxA',
  ...
  },
  {
    ...
    source: 'https://www.thivien.net/Thế-Lữ/Nhớ-rừng/poem-_ykWImldKwdEntynhnNLUA',
  ...
  {
    // Vietnamese folk poetry (ca dao)
    label: 'Ca dao Việt Nam — Công cha nghĩa mẹ',
    text: 'Công cha như núi Thái Sơn, nghĩa mẹ như nước trong nguồn chảy ra. Một lòng thờ mẹ kính cha, cho tròn chữ hiếu mới là đạo con.',
  },
  {
    label: 'Hàn Mặc Tử — Đây thôn Vĩ Dạ',
    source: 'https://www.thivien.net/Hàn-Mặc-Tử/Đây-thôn-Vĩ-Dạ/poem-mYEcs2AZA6uARv-MA69oaA',
  ...
  },
  {
    ...
    source: 'https://www.thivien.net/Huy-Cận/Tràng-giang/poem-tzEin01iG68zsm2nWGm0IQ',
  ...
  },
  {
    ...
    source: 'https://www.thivien.net/Lưu-Trọng-Lư/Tiếng-thu/poem-jvbfrjspi2Y6S8b3jeqzpA',
  ...
  },
  {
    ...
    source:
      'https://www.thivien.net/Phạm-Tiến-Duật/Bài-thơ-về-tiểu-đội-xe-không-kính/poem-2ZBCmv-1-OtKQTAwZYF7Kw',
