...
export const ar: ForeignSample[] = [
  ...
  },
  {
    ...
    label: 'Arabic Proverbs — أمثال عربية',
    text: 'العلم نور والجهل ظلام من جد وجد ومن زرع حصد الصبر مفتاح الفرج كل إناء بما فيه ينضح إذا هبت رياحك فاغتنمها',
  },
  {
    // https://www.goodreads.com/book/show/5488.The_Cairo_Trilogy
    label: 'Naguib Mahfouz — أولاد حارتنا',
    text: 'هذه حكاية حارتنا وحكايات حارتنا عجيبة ولها بداية ولكن ليس لها نهاية وأعجب ما فيها أنها مبنية على الحق والعدل والمحبة',
  },
  {
