...
export const sv: Sample[] = [
  {
    ...
    source: 'https://archive.org/details/nilsholgerssons00lybegoog',
  ...
  },
  {
    ...
    source: 'https://www.gutenberg.org/files/57052/57052-h/57052-h.htm',
  ...
  },
  {
    ...
    source: 'https://runeberg.org/berling/i01.html',
  ...
  },
  {
    ...
    source: 'https://sv.wikisource.org/wiki/Du_gamla,_du_fria_(Dybeck)',
  ...
  },
  {
    ...
    source: 'https://sv.wikisource.org/wiki/Doktor_Glas/12_juni',
    text: 'Jag har aldrig sett en sådan sommar. Rötmånadshetta sedan mitten av maj. Hela dagen står ett tjockt töcken av damm alldeles stilla över gatorna och torgen.',
  },
  {
    label: 'Tomas Tranströmer — Romanska bågar',
    source: 'https://www.lyrikline.org/en/poems/romanska-bagar-7605',
  ...
  },
  {
    ...
    source: 'https://www.karinboye.se/verk/dikter/dikter/i-rorelse.shtml',
  ...
  },
  {
    ...
    source: 'https://www.lyrikline.org/en/poems/schubertiana-7604',
  ...
  {
    label: 'Verner von Heidenstam — Karolinerna: Trontagaren',
    source: 'https://runeberg.org/karolin/03.html',
    text: 'Vad heter du? frågade han pagen. Varför svarar du inte? Pagen andades häftigt och famlade och plockade på sina kläder. Nå, men svara då, gosse! Du vet väl ditt eget namn. Du står ju nästan med ryggen åt mig, så att jag inte kan se dig. Nu steg pagen fram mitt i kammaren och lyfte peruken från huvudet.',
  },
  {
    label: 'August Strindberg — Fadren',
    source: 'https://runeberg.org/fadren/a2.html',
  ...
  },
  {
    ...
    source: 'https://sv.wikisource.org/wiki/Fj%C3%A4riln_vingad_syns_p%C3%A5_Haga',
  ...
  {
    label: 'Verner von Heidenstam — Karolinerna: Gunnel Fatburshustru',
    source: 'https://runeberg.org/karolin/05.html',
  ...
  },
  {
    ...
    source: 'https://runeberg.org/strindbg/hemsobor/h1.html',
    text: 'Men det gör inget, det; han ska få arbeta för maten, och inte ska han komma mig för när, inte. Ja si, du tror aldrig vad jag säger, men du får väl se, du får väl se! Och så ångrar du dig, när det är för sent!',
  },
  {
    label: 'Gustaf Fröding — En fattig munk från Skara',
    source: 'https://runeberg.org/dragharm/fattmunk.html',
    text: 'Och han, som sitter så mäktig i Rom, han får väl utan mig sin dom med munkar och höga präster, som kalla sig doktor och mäster. Och herren, som sitter så stolt i sin borg, han får väl att bära, han ock, sin sorg, och sorgen den träffar väl hertig och kung, på kejsaren själv faller sorgen tung.',
  },
  {
    label: 'Erik Axel Karlfeldt — Kom i lunden',
    source:
      'https://sv.wikisource.org/wiki/Erik_Axel_Karlfeldts_dikter/Fridolins_lustg%C3%A5rd_och_Dalm%C3%A5lningar_p%C3%A5_rim/Kom_i_lunden',
    text: 'Fägring flyr; på ängen mister sista nejlikan sin glöd — visans mö på lätta vrister dansar alltid frisk och röd.',
  },
  {
    label: 'August Strindberg — Ett drömspel',
    source: 'https://runeberg.org/dromspel/',
  ...
  },
  {
    ...
    source: 'https://runeberg.org/sodrgran/01_13.html',
  ...
  },
  {
    ...
    source: 'https://runeberg.org/jerusalm/0007.html',
    text: 'Det var en ung karl, som gick och plöjde sitt träde en sommarmorgon. Solen sken ljuvligt, gräset var vått av dagg, och luften var så frisk, så att det kunna inga ord beskriva.',
  },
  {
    label: 'Edith Södergran — Landet som icke är',
    source: 'https://www.swedishfinnhistoricalsociety.org/2021/11/19/poems-by-edith-sodergran/',
  ...
  },
  {
    ...
    source: 'https://runeberg.org/mbirck/',
