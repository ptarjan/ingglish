...
async function main(): Promise<void> {
  ...
  // Write as TypeScript module to prevent bundler from tree-shaking keys into variables
  // (reserved words like 'arguments' and 'await' would break the build)
  // Use explicit type annotation to avoid "inferred type exceeds maximum length" error
