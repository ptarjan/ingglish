...
const REVERSE_OUTPUT_PATH = path.join(__dirname, '..', 'src', 'dictionary', 'reverse-cmudict.ts');
...
async function main(): Promise<void> {
  ...
  //
  // Phonemes are pre-split into arrays at build time to avoid runtime
...
async function generateReverseDictionary(dict: CMUDictionary): Promise<void> {
  ...
  const tsContent = `// Auto-generated reverse CMU dictionary - do not edit
// Generated by scripts/build-dictionary.ts
// Maps phoneme sequences (stress-stripped) to words sorted by frequency
const reverseCmudict: Record<string, string[]> = ${JSON.stringify(reverseDict, null, 2)};
export default reverseCmudict;
`;

  await fs.writeFile(REVERSE_OUTPUT_PATH, tsContent);
