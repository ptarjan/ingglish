...
console.log('='.repeat(90));
console.log('These are words where CMU uses AH with primary/secondary stress (representing /ʌ/).');
...
console.log('='.repeat(90));
console.log('Three consonants in a row — many are valid, but some may indicate missing vowels.\n');
...
console.log('='.repeat(90));
console.log('These are the ~100 most common English function words with their CMU pronunciations.');
