...
const yGlideWords = new Map<string, { hasYGlide: boolean; position: number; consonant: string }>();
...
printSection('PATTERN 6: Latin/Greek -ile suffix with AY L (British) vs AH L (American)', pattern6);
